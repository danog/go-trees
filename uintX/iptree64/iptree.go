...
func (t *Tree) InsertNet(n *net.IPNet, value uint64) *Tree {
	if n == nil {
		return t
	}
...
func (t *Tree) InplaceInsertNet(n *net.IPNet, value uint64) {
	if n == nil {
		return
	}
...
func (t *Tree) InsertIP(ip net.IP, value uint64) *Tree {
...
func (t *Tree) InplaceInsertIP(ip net.IP, value uint64) {
...
func (t *Tree) GetByNet(n *net.IPNet) (uint64, bool) {
	if t == nil || n == nil {
		return 0, false
	}
...
func (t *Tree) GetByIP(ip net.IP) (uint64, bool) {
