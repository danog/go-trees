...
func (t *Tree) InsertNet(n *net.IPNet, value uint32) *Tree {
	if n == nil {
		return t
	}
...
func (t *Tree) InplaceInsertNet(n *net.IPNet, value uint32) {
	if n == nil {
		return
	}
...
func (t *Tree) InsertIP(ip net.IP, value uint32) *Tree {
...
func (t *Tree) InplaceInsertIP(ip net.IP, value uint32) {
...
func (t *Tree) GetByNet(n *net.IPNet) (uint32, bool) {
	if t == nil || n == nil {
		return 0, false
	}
...
func (t *Tree) GetByIP(ip net.IP) (uint32, bool) {
